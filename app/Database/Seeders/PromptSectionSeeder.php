...
final class PromptSectionSeeder extends Seeder
{
    ...
    public function run(PDO $pdo): void
    {
        ...
        if ($driver === 'pgsql') {
            $sql = 'INSERT INTO prompt_section (key, title, description, order_index, enabled, created_at, updated_at)
                    VALUES (:key, :title, :description, :order_index, :enabled, :created_at, :updated_at)
                    ON CONFLICT (key) DO NOTHING';
        } else {
            $sql = 'INSERT OR IGNORE INTO prompt_section (key, title, description, order_index, enabled, created_at, updated_at)
                    VALUES (:key, :title, :description, :order_index, :enabled, :created_at, :updated_at)';
        }
